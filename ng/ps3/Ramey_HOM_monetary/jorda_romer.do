...
local q = 0;  /* q = 0 corresponds to recursiveness assumption, q = 1 is less restrictive */

local favar = 0;  /* favar= 0 is no FAVAR, favar = 1 is with factors */
...
outsheet h bffr lo90bffr up90bffr blip lo90blip up90blip bunemp lo90bunemp up90bunemp
 blcpi lo90blcpi up90blcpi using junk.csv is h<=48, replace comma ;
